...
\begin{abstract}
The emphasis on data-driven and evidence based decision making

Knowledge from data can lead to better decisions and actions.

Open data movement

smart city

Issues of accessing, interpreting and making sense of open data for usages in local action. Making data relevant to people

Use data as raw data
