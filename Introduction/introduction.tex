...
This thesis investigates how citizens can effectively use data in civic participation, advocacy and action. 

A lot of data is being generated

Data is becoming something that is essential in decision making processes in organisational structures and in governance.
For example census or product development etc.

In order to transform data into  something valuable and actionable, people use DIKW pyramid \citep{ackoff_data_1989}
These theories are used in business intelligent, systematic thinking and engineering, organisational memory and knowledge creation

However we are now in a different context, but still working with data
In civic context and nonprofessionals using data these methods don’t work



role of data in civic participation, advocacy and action. 
